...
public class BoulderBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    private final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(10, ItemStack.EMPTY);


    public BoulderBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.BOULDER_BLOCK_ENTITY, pos, state);
    }
    ...
    public Text getDisplayName() {
        return Text.literal("Boulder Block");
    }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new BoulderBlockScreenHandler(syncId, playerInventory, this, null);
    }
